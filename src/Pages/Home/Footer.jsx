    ...
    <div className="w-full h-fit py-20 mt-4 flex justify-center items-center text-white bg-black">
      <div className="flex lg:flex-row lg:w-auto pl-8    w-full flex-col gap-20">
        <div className="flex flex-col lg:pr-40 gap-9 ">
          ...
          <p className="text-sm text-[#FFFFFF5A] text-[16px]">Subscribe Our Newsletter:</p>
        ...
        <ul className="flex text-3xl font-semibold flex-col gap-6">
          <li className="hover:text-[#ff9800] cursor-pointer hover:scale-200 duration-400">
            Home{" "}
          </li>
          <li className="hover:text-[#ff9800] cursor-pointer hover:scale-200 duration-400">
            Portfolio
        ...
        <ul className="flex flex-col text-[#FFFFFF5A]  gap-6">
          <li className="hover:text-white hover:scale-110 duration-200">Privacy Policy</li>
          <li className="hover:text-white hover:scale-110 duration-200">Terms and Conditions </li>
          <li className="hover:text-white hover:scale-110 duration-200">Cookie Policy</li>
          <li className="hover:text-white hover:scale-110 duration-200">Careers</li>
