...
const Sec5 = () => {
  return (
    <div className="sec-5 w-full mt-50 flex items-center justify-center">
      <div className="parent w-350 h-[120vh] px-9 flex flex-col">
        <div className="flex justify-between px-15 header pb-20">
        ...
        <div className="w-full  image-1 flex justify-center gap-4    h-fit">
          <div className="flex flex-col gap-8 w-[45%]  overflow-hidden h-fit ">
            <img
              src={img1}
              alt=""
            ...
            <h1 className="text-2xl font-semibold w-120">
