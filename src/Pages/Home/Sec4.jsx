...
const Sec4 = () => {
  return (
    <div className="lg:h-[160vh] h-[240vh] w-full  justify-center items-center flex flex-col  mt-30 bg-gray-100 relative">
      <div className="h-[1px] w-80 bg-gray-400 hidden lg:flex absolute top-23    right-0 ">
        {" "}
      </div>
      ...
      <div className="lg:w-[75vw] w-75    text-black justify-center items-center flex flex-col   ">
        ...
        <div className=" flex flex-col gap-9 items-center justify-center pt-20 pb-6">
          ...
          className="lg:w-200 w-80 leading-9 text-[#00000080] text-center text-xl lg:text-2xl">
            ...
            this creative agency, and I must say,
            they truly impressed me. They 
            consistely think outside the box,
            resulting in impressive and
            impactfull work. I highly recommed
            
            this agency for their consistent
             delivery of exceptional creative
            solutions.
          </motion.p>
        </div>
